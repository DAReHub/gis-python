...
def main(baseline_events_filepath: str, scenario_events_filepath:str, scenario_name:str, pt_vehicles_filepath: str, output_dir_filepath: str):
	...
	Input_filePaths_list = [baseline_events, scenario_events, pt_vehicles]
